...
#define STRING_CONFIG_H_AUTHOR "(thezak48, Ender Dave Stable config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender Dave"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 799.8 }
